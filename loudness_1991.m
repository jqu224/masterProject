...
% t2 = text(1,1,'N [sone] =')
text(0.7, 0.75, num2str(N),'Units','normalized');
% text(5,1,num2str(N))
title('partial loudness')

% caxis([0,1.4]) 

[sharp] = sharpness_Fastl(N_single);
text(0.3, 0.6, 'Sharpness [acum] =','Units','normalized');
% text(1,0.8,'Sharpness [acum] =')
text(0.7, 0.55, num2str(sharp),'Units','normalized');
% text(5.5,0.6,num2str(sharp))
hold off
